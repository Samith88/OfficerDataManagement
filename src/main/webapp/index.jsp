  ...
  <body>
    <form action="main.jsp">
      ...
      <div class="container">
        ...
        <input type="text" placeholder="පරිශීලක නාමය ඇතුළත් කරන්න" name="uname" required>
        <label for="psw"><strong>මුරපදය</strong></label>
        <input type="password" placeholder="මුරපදය ඇතුළත් කරන්න" name="psw" required>
      </div>
